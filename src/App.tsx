...
function App() {
	...
	const [countdownSwitch, setCountdownSwitch] = useState<boolean>(false);
	const { remainingSeconds } = useTimer({ seconds: 0, start: countdownSwitch })
	...
	function handelPlay(nextSquares: BoardType) {
		...
		setCountdownSwitch(true)
	}

	function jumpTo(nextMove: number) {
		setCurrentMove(nextMove);
	}
	function gameOver(value: boolean) {
		console.log(value);

		setCountdownSwitch(value)
	}
